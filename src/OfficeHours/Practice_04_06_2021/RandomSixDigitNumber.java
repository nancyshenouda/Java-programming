...
meaning the number 6 digit number should have
6 different character numbers that make it up. Print the number.
...
public class RandomSixDigitNumber {
    public static void main(String[] args) {
        ...
        while(randomNumber.length()!=6){
            int eachRandom = random.nextInt(10);  //random numbers between 0 to 9
