...
public class FacebookUsers extends SocialMedia{
    ...
    public FacebookUsers(String username, String password){
    ...
    public FacebookUsers(String username, String password, String fullName){
        this(username, password);
        setFullName(fullName);
    }

    public FacebookUsers(String username, String password, String fullName, int age, int numberOfFriends){
    ...
    public boolean sendFriendRequest(FacebookUsers other){
